...
export function DynamicEvalsDashboard() {
    ...
    <div>
      {loaded && evals.length === 0 ? (
        <EmptyState
          ...
          title="No Dynamic Evaluations yet"
          description="Start a chat (or auto-pilot session) with a character, then click Dynamic Eval from the chat top-bar to score it. Reports show up here."
          action={
            <Link href="/chat/new">
              <Button>
                      ...
                      >
                        ...
                        <td className="px-3 py-2 text-right">
                          <div className="flex items-center justify-end gap-1">
                            ...
                            <Link
                              href={`/chat/${e.sessionId}?continue=manual`}
                              aria-label="Continue this chat manually"
                              title="Continue chat — take over the user side; the character LLM keeps responding normally"
                              className="inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-card hover:text-foreground"
                            >
                            ...
                            <Button
                              ...
                              aria-label="Download Dynamic Eval as JSON"
                              title="Download JSON"
                            >
                            ...
                            <Button
                              ...
                              aria-label="Delete Dynamic Eval"
                            >
      ...
      <Dialog
        ...
        title="Delete this Dynamic Eval?"
        description={
          pendingDelete
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex shrink-0 items-center gap-2 text-xs">
              <Link
                href={`/chat/${reports[0].sessionId}?continue=manual`}
                title="Continue this character's most recent chat manually"
